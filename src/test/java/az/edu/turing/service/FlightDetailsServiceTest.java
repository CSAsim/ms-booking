...
import az.edu.turing.service.impl.FlightDetailsServiceImpl;
...
class FlightDetailsServiceTest {
    ...
    void findByFlightId_ShouldReturn_Success() {
        ...
        FlightDetailsDto result = flightDetailsService.findByFlightId(FLIGHT_ID);
    ...
    void crateFlightDetails_Should_ReturnSuccess() {
        ...
        FlightDetailsDto result = flightDetailsService.create(USER_ID, CREATE_FLIGHT_DETAILS_REQUEST);
